...
<img src="<?php echo bloginfo('stylesheet_directory');?>/images/logo.gif" alt="<?php bloginfo( 'name' ); ?>" width="50" height="50"/>&nbsp&nbsp
<div id="tile_description"><?php bloginfo( 'name' ); ?>
